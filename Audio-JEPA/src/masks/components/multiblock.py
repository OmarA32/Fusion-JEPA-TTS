...
class MaskCollator(object):
    ...
    def _sample_block_mask(self, b_size, acceptable_regions=None, generator=None):
        h, w = b_size
    ...
    def __call__(self, batch):
        ...
        for _ in range(B):
            ...
            for _ in range(self.nenc):
                mask, _ = self._sample_block_mask(e_size, acceptable_regions=acceptable_regions, generator=g)
                masks_e.append(mask)
        ...
        collated_batch.prediction_masks = collated_masks_pred
        # --
        collated_masks_enc = [[cm[:min_keep_enc] for cm in cm_list] for cm_list in collated_masks_enc]
        collated_masks_enc = torch.utils.data.default_collate(collated_masks_enc)
        collated_batch.context_masks = collated_masks_enc
