...
# Matches D-JEPA paper settings (4x A100 GPUs, 2600 Epochs, LJSpeech)
# ==============================================================================
...
echo "=========================================================="
echo "Starting JEPA TTS Training on 4x A100 GPUs (2,600 Epochs)"
...
# 4x A100 GPUs, 2600 Epochs on LJSpeech English Benchmark
