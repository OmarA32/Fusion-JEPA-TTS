...
if "%args%"=="" (
    ...
    echo.
    echo   Examples:
    echo     launchers\inference\inference.bat --lang english --text "Hello world from Fusion-JEPA"
    echo     launchers\inference\inference.bat --lang arabic --text "مرحبا بكم" --save-mel
    echo     launchers\inference\inference.bat --lang english --db ljspeech --index 108 --save-mel
    echo ==============================================================================
    set /p args="Enter arguments (or press Enter for default Arabic synthesis): "
)

python pipelines/inference.py %args%
pause
