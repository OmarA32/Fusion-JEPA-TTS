...
#   4. Submit this script to the queue: sbatch launchers/run_ibex_phase1.sh "YOUR_HF_TOKEN_HERE"
# ==============================================================================

#SBATCH --job-name=jepa_tts_phase1
...
#SBATCH --time=08:00:00           # 8-hour strict time limit
#SBATCH --output=training_logs/ibex_output_%j.txt
#SBATCH --error=training_logs/ibex_error_%j.txt

echo "=========================================================="
echo "Starting JEPA TTS Training (PHASE 1: UNFROZEN ALIGNMENT WARMUP) on A100"
...
echo "Booting up the Trainer with JEPA Backbone UNFROZEN (Phase 1)..."
python train.py --resume --download_latest --lang arabic --db nawar_halabi --hf_token "$1" --checkpointnum 20 
