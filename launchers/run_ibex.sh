...
#SBATCH --gres=gpu:a100:4         # Request 4x NVIDIA A100 GPUs for massive parallel training
#SBATCH --cpus-per-task=32        # Request 32 CPU cores (8 per GPU) for fast data loading
...
echo "=========================================================="
echo "Starting JEPA TTS Training on KAUST Ibex Supercomputer"
