...
#   4. Submit this script to the queue: sbatch launchers/run_ibex_arabic_freeze_diffuser.sh "YOUR_HF_TOKEN_HERE"
# ==============================================================================

#SBATCH --job-name=jepa_tts_ar_frz_diff
...
echo "=========================================================="
echo "Starting JEPA TTS Training (Arabic - Diffuser Frozen) on KAUST Ibex Supercomputer"
...
echo "Booting up the PyTorch Lightning Trainer with Diffuser weights FROZEN..."
python training/train.py --resume --download_latest --lang arabic --db nawar_halabi --hf_token "$1" --checkpointnum 60 --freeze_diffuser
