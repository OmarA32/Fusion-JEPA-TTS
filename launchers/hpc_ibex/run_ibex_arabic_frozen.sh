...
#   4. Submit this script to the queue: sbatch launchers/run_ibex_arabic_frozen.sh "YOUR_HF_TOKEN_HERE"
# ==============================================================================

#SBATCH --job-name=jepa_tts_arb_frozen
...
echo "=========================================================="
echo "Starting JEPA TTS Training (ARABIC, JEPA FROZEN) on KAUST Ibex"
...
echo "Booting up the PyTorch Lightning Trainer with JEPA Backbone frozen..."
python training/train.py --resume --download_latest --lang arabic --db nawar_halabi --hf_token "$1" --checkpointnum 20 --freeze_jepa
