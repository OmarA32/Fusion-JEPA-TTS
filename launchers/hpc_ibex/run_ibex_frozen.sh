...
#   4. Submit this script to the queue: sbatch launchers/run_ibex_frozen.sh "YOUR_HF_TOKEN_HERE"
# ==============================================================================

#SBATCH --job-name=jepa_tts_frozen
...
echo "=========================================================="
echo "Starting JEPA TTS Training (ENGLISH, JEPA FROZEN) on KAUST Ibex"
...
python training/train.py --resume --download_latest --lang english --db ljspeech --hf_token "$1" --checkpointnum 20 --freeze_jepa
