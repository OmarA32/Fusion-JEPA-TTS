...
#   4. Submit this script to the queue: sbatch launchers/run_ibex_english_freeze_diffuser.sh "YOUR_HF_TOKEN_HERE"
# ==============================================================================

#SBATCH --job-name=jepa_tts_en_frz_diff
...
echo "=========================================================="
echo "Starting JEPA TTS Training (English - Diffuser Frozen) on KAUST Ibex Supercomputer"
...
python training/train.py --resume --download_latest --lang english --db ljspeech --hf_token "$1" --checkpointnum 20 --freeze_diffuser
