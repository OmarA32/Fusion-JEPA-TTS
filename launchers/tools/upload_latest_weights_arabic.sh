#!/bin/bash
# ==============================================================================
# SLURM submission script for KAUST IBEX Supercomputer -- Upload Arabic Weights
# ==============================================================================
# HOW TO DEPLOY ON IBEX:
#   sbatch launchers/tools/upload_latest_weights_arabic.sh "YOUR_HF_TOKEN_HERE"
# ==============================================================================

#SBATCH --job-name=ul_weights_ar
...
echo "=========================================================="
echo "Starting Upload of Latest Arabic Weights on IBEX"
...
# 6. Upload latest Arabic weights to Hugging Face
echo "Uploading latest Arabic checkpoint to Hugging Face..."
if [ -n "$1" ]; then
    python tools/upload_to_hf.py --lang arabic --token "$1"
else
    python tools/upload_to_hf.py --lang arabic
fi
