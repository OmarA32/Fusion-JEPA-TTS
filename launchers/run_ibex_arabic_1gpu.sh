...
# (1x A100 GPU, 2600 Epochs, Nawar Halabi)
# ==============================================================================
# HOW TO DEPLOY ON IBEX:
#   1. SSH into the GPU login node: ssh -XY username@glogin.ibex.kaust.edu.sa
#   2. cd Fusion-JEPA-TTS
#   3. Submit this script: sbatch launchers/run_ibex_arabic_1gpu.sh "YOUR_HF_TOKEN_HERE"
# ==============================================================================
...
echo "=========================================================="
echo "Starting JEPA TTS Arabic Training on 1x A100 GPU (2,600 Epochs)"
